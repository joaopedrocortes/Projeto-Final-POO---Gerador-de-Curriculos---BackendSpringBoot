...
public class CurriculoBuilder {
    ...
    public CurriculoBuilder cpf(String cpf) {curriculo.setCpf(cpf); return this; }
    public CurriculoBuilder endereco(String endereco) {curriculo.setEndereco(endereco); return this; }
    public CurriculoBuilder telefone(String telefone) {curriculo.setTelefone(telefone); return this; }
